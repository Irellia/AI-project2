...
if __name__ == "__main__":
    self_train(instance=150, filename_in="new_50_lr=05.pickle", filename_out="new_200_lr=05.pickle")
    self_train(instance=200, filename_in="new_200_lr=05.pickle", filename_out="new_400_lr=05.pickle")
    self_train(instance=200, filename_in="new_400_lr=05.pickle", filename_out="new_600_lr=05.pickle")
    self_train(instance=200, filename_in="new_600_lr=05.pickle", filename_out="new_800_lr=05.pickle")
    self_train(instance=200, filename_in="new_800_lr=05.pickle", filename_out="new_1000_lr=05.pickle")
    self_train(instance=200, filename_in="new_1000_lr=05.pickle", filename_out="new_1200_lr=05.pickle")
    self_train(instance=200, filename_in="new_1200_lr=05.pickle", filename_out="new_1400_lr=05.pickle")
    self_train(instance=200, filename_in="new_1400_lr=05.pickle", filename_out="new_1600_lr=05.pickle")
